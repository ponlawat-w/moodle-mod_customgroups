...
$string['cannotcreategroup'] = 'Cannot create group';
$string['cannoteditgroup'] = 'Cannot edit group';
...
$string['cannotjoingroup'] = 'Cannot join group.';
...
$string['createdgroup'] = 'Created Group';
...
$string['eventgroupcreated'] = 'Custom group created';
$string['eventgroupdeleted'] = 'Custom group deleted';
$string['eventgroupjoined'] = 'Custom group joined';
$string['eventgroupleft'] = 'Custom group left';
$string['eventgroupsapplied'] = 'Custom groups applied';
$string['eventgroupupdated'] = 'Custom group updated';
...
$string['joinedgroup'] = 'Joined Group';
...
$string['modulealreadyapplied'] = 'Module is already applied to course.';
...
$string['modulenotactive'] = 'Module is not active';
$string['nogrouping'] = 'No grouping';
$string['nopermissiontocreategroup'] = 'User does not have permission to create group or there is already a group created by this user in the module.';
$string['notownercannotcreate'] = 'Cannot edit group because user is not group owner.';
...
$string['privacy:metadata:customgroups_groups'] = 'Groups created by students.';
$string['privacy:metadata:customgroups_groups:course'] = 'Course that contains the group.';
$string['privacy:metadata:customgroups_groups:description'] = 'Group description.';
$string['privacy:metadata:customgroups_groups:module'] = 'Course module that contains the group.';
$string['privacy:metadata:customgroups_groups:name'] = 'Group name.';
$string['privacy:metadata:customgroups_groups:userid'] = 'ID of the user who created the group.';
$string['privacy:metadata:customgroups_joins'] = 'Group joining information.';
$string['privacy:metadata:customgroups_joins:groupid'] = 'Joined group ID.';
$string['privacy:metadata:customgroups_joins:userid'] = 'ID of the user who joined the group.';
$string['timelinesettings'] = 'Timeline Settings';
$string['usernotingroup'] = 'The user is not in this group.';
