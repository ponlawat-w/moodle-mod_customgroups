...
class group_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventgroupupdated', 'mod_customgroups');
    }
    ...
    public function get_description() {
        return "The user with the id '{$this->userid}' updated the custom group with id '{$this->objectid}'.";
    }
    ...
    /**
     * Create an event instance from group record
     *
     * @param \stdClass $record
     * @param \core\context\module $modcontext
     * @return \mod_customgroups\event\group_updated
     */
    public static function createfromrecord(\stdClass $record, \core\context\module $modcontext) {
