...
class group_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventgroupcreated', 'mod_customgroups');
    }
    ...
    public function get_description() {
        return "The user with the id '{$this->userid}' created a new group in a custom group module.";
    }
    ...
    /**
     * Create an event instance from record id
     *
     * @param int $newid
     * @param \core\context\module $modcontext
     * @return \mod_customgroups\event\group_created
     */
    public static function createfromid(int $newid, \core\context\module $modcontext) {
